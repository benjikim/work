...
const value = computed(() => formStore.getTravelerLastName(props.index));
...
const handleBlur = (data) => {
  ...
  if (!v$.value[props.modelId].$error) {
    formStore.setTravelerLastName(data, props.index);
  } else {
    formStore.setTravelerLastName(null, props.index);
  }
};
